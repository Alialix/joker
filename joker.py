...
"""
joker: Find Usernames Across Social Networks Module
...
module_name = "joker: Find Usernames Across Social Networks"
__version__ = "0.2.7"
amount = 0
...
def joker(username, site_data, verbose=False, tor=False, unique_tor=False, proxy=None):
    """Run joker Analysis.
...
|____/|_| |_|\___|_|  |_|\___/ \___|_|\_\    /`--.'--'   \ .-.
    ...
    for username in args.username:
        print()
        results = {}
        results = joker(username, site_data, verbose=args.verbose,
